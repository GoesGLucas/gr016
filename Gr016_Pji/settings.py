#settings
"""
Django settings for Gr016_Pji project.
...
ROOT_URLCONF = 'Gr016_Pji.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'core', 'templates')],  # Isso deve apontar para o diretório de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Gr016_Pji.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'HCGTEYjdrymdmQjjffzemAuDNgUlFQYJ',
